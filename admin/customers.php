  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
        ...
        <!-- <div class="col-2">
          <button data-toggle="modal" data-target="#add_customer_modal" class="btn btn-primary btn-sm">Add Customer</button>
        </div> -->
      </div>
...
<div class="modal fade" id="add_customer_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  while($row = mysqli_fetch_array($result)) {
           ...
           <div class="col-12">
              <input type="submit" name="customers" class="btn btn-primary add-product" value="Add Entry">
            </div>
          </div>
